...
namespace DALTWNC_QUIZ.Pages.Admin.QuestionsBank
{
    ...
    public class IndexModel : PageModel
    {
        ...
        public List<object> SubjectCategoryMap { get; set; } = new();
        ...
        public async Task OnGetAsync()
        {
            ...
            CategorySL = new SelectList(
                await _context.QuestionCategories.AsNoTracking().ToListAsync(),
                "CategoryID",
                "CategoryName",
                CategoryFilterId
            );
            ...
            {
                questionQuery = questionQuery.Where(q => q.CategoryID == CategoryFilterId);
            }
